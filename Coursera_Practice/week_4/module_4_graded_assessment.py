...
# address string into new strings:
...
# For example, "123 Main Street", "1001 1st Ave",
...
# and then Jamie took over. After the class,
# they each entered their lists into the computer
# and emailed them to the professor,
# who needs to combine them into one,
# in the order of each student's arrival.
# Jamie emailed a follow-up, saying that her
# list is in reverse order. Complete the steps to
# combine them into one list as follows:
# the contents of Drew's list, followed by Jamie's list
...
# The function receives the variables start and end, and returns
...
# friends and how many guests each friend is bringing.
...
# with each friend listed only once, and the number of guests from
# Rory's dictionary taking precedence, if a name is included in
